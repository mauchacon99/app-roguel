        ...
        <div className="container max-w-screen-xl mx-auto px-4">
          <nav className="flex-wrap lg:flex items-center py-14 xl:relative z-10">
            <div className="flex items-center justify-between mb-10 lg:mb-0">
              ...
              <button
                className="lg:hidden w-10 h-10 ml-auto flex items-center justify-center text-golden-primary border border-golden-primary rounded-md"
            ...
            <button
              className={` ${
                navbarOpen ? "flex" : "hidden"
              }  px-5 py-3 lg:block border-2 border-golden-primary rounded-lg font-semibold
                 text-golden-primary text-lg hover:bg-golden-primary hover:text-white transition ease-linear duration-500 `}
            >
              Request quote
            </button>
          </nav>
          ...
          <div className="flex items-center justify-center xl:justify-start">
            <div className="mt-28 text-center xl:text-left">
              ...
              <p className="font-normal text-xl text-gray-400 leading-relaxed mb-12">
                Having a sweet home is everyones dream. Have you <br /> owned
                your dream house?
              </p>

              <button className="px-6 py-4 bg-golden-primary text-white font-semibold text-lg rounded-xl hover:bg-green-900 transition ease-in-out duration-500">
                Contact us
              </button>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-center md:space-x-8 lg:space-x-12 mb-10 md:mb-20">
            <div className="bg-gray-100 rounded-lg mb-10 md:mb-0">
              ...
              <p className="font-normal text-sm lg:text-md text-gray-400 mx-8 my-8">
                I recommend anyone to buy house on <br /> D’house. I received
                great customer service <br /> from the specialists who helped
                me.
              </p>
            ...
            <div className="bg-gray-100 rounded-lg">
              ...
              <p className="font-normal text-sm lg:text-md text-gray-400 mx-8 my-8">
                D’house is the best property agent in the <br /> world. I
                received great customer service <br /> from the D’house agent
              </p>
        ...
        <div className="container max-w-screen-xl mx-auto px-4 xl:relative">
          <div className="bg-green-800 flex flex-col lg:flex-row items-center justify-evenly py-14 rounded-3xl">
            ...
            <div className="hidden md:block bg-white xl:relative px-6 py-3 rounded-3xl">
              ...
              <div className="py-3">
                <button className="w-full py-4 font-semibold text-lg text-white bg-golden-primary rounded-xl hover:bg-green-900 transition ease-in-out duration-500">
                  Booking
                </button>
              </div>
            </div>
